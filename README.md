...
Across AI systems, infrastructure, governance, and cognition —
...
They are **constraint-driven reasoning artifacts** -
...
* **🟢 🏷️ [Power Asymmetry Restraint Protocol - PARP](https://github.com/leenathomas01/Power-Asymmetry-Restraint-Protocol-PARP)** — power asymmetry restraint
* **🟢 🏷️ [Doctrine of Externalization](https://github.com/leenathomas01/doctrine-of-externalization)** — safety via external auditability
* **🟢 🏷️ [The Consult Model](https://github.com/leenathomas01/the-consult-model)** — assistance under liability constraints
...
* **🟢 🏷️ [Unlearnable Interference](https://github.com/leenathomas01/Unlearnable-Interference)** — adversarial signal limits
...
* **🟢 🏷️[Selective Decode Broadcast (SDB)](https://github.com/leenathomas01/SDB-Selective-Decode-Broadcast)** 
  Per-recipient isolation with deterministic auditability
...
* **🟢 🏷️ [Phase-Aligned Inquiry](https://github.com/leenathomas01/phase-aligned-inquiry)**
  Enforces sequencing, falsifiability, and honest failure
